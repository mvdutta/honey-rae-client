...
export const TicketList = () => {
  ...
  const {
    ...
    setOriginal,
    condensed: tickets,
  } = useCondensed({ limit: 40, field: "description" });
  ...
  return (
    <>
      <div>
        ...
        <button onClick={() => filterTickets("unclaimed")}>
          Show Unclaimed
        </button>
        <button onClick={() => filterTickets("inprogress")}>
          Show In Progress
        </button>
      </div>
